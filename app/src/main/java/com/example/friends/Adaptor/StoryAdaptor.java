...
import com.example.friends.databinding.StoryRvDesignBinding;
...
public class StoryAdaptor extends RecyclerView.Adapter<StoryAdaptor.viewHolder>{
    ...
    ArrayList<StroyModel>list;
    Context context;

    public StoryAdaptor(ArrayList<StroyModel> list, Context context) {
        this.list = list;
        ...
        if (story.getStories().size() > 0) {
            ...
            FirebaseDatabase.getInstance().getReference()
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    holder.binding.stroyImg.setOnClickListener(new View.OnClickListener() {
                        @Override
